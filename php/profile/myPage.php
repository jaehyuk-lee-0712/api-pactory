                ...
                <div class="right__main column4">
                   ...
                   <div class="Mypassbox">
                    <label for="userPass" class="required">비밀번호</label>
                        <input type="password" name="userPass" id="userPass" placeholder="현재 비밀번호"
                            autocomplete="off" class="input-style" required>
                </div>
                <div class="Mypassbox">
                    <label for="userPass" class="required">비밀번호 변경</label>
                        <input type="password" name="changePass" id="userPass" placeholder="변경할 비밀번호"
                            autocomplete="off" class="input-style" required>
                </div>
                <div class="Mypassbox">
                    <label for="userPass" class="required">비밀번호 확인</label>
                        <input type="password" name="configPass" id="userPass" placeholder="비밀번호 확인"
                            autocomplete="off" class="input-style" required>
                </div>
